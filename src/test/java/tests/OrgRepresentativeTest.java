...
public class OrgRepresentativeTest extends BaseTest {
    ...
    public void testCreateOrgRepBooking() {
        ...
        bookingPage.selectOrganisation();

        // Fill Client Information
        bookingPage.selectClient("Sarvesh", "SARVESH - sarvesh org - ORGANISATIONALREPRESENTATIVE")
